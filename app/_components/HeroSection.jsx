    ...
    <>
      <div className="w-[full] h-[100vh] flex justify-center items-center">
        <div className="relative">
          ...
          <motion.div initial={{top:'0px',left:'0px'}} whileInView={{top:'10px',left:'-10px'}} transition={{ duration: 0.3,amount:0.5,delay:0.5, type: "spring" }}
            className={`relative  hidden xl:flex justify-center items-center text-9xl text-black text-center ${myFont.className}`}
            >
            {text}
          </motion.div>
          <div
