...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 w-full h-20 flex items-center bg-opacity-80 bg-[#252525CC] z-10 px-4 font-classic">
        {/* Logo Section */}
        ...
        <div className="flex flex-1 justify-end gap-x-4">
          ...
          {isMenuOpen && (
            <div className="absolute top-20 right-16 bg-[#252525CC] text-white rounded-md shadow-lg p-4 w-[196px] text-right text-xl">
              <Link
                href="/team"
          ...
          {isUserMenuOpen && (
            <div className="absolute top-20 right-4 bg-[#252525CC] text-white shadow-lg p-4 w-[196px] text-right text-xl">
              {!isLoggedIn ? (
                <>
                  <Link
                    href="/login"
