            ...
            {!showYearPicker ? (
              <div>
                <button
                  ...
                  className="w-full py-2 text-sm font-medium text-gray-900 hover:bg-gray-100"
                >
                  {month.getFullYear()} - Click to change year
                </button>
                <DayPicker
                  mode="single"
                  selected={date}
              ...
              <div className="max-h-60 overflow-y-auto">
                {generateYearOptions().map((year) => (
                  <button
                    ...
                    className="w-full py-2 text-sm text-gray-900 hover:bg-gray-100"
                  >
                    {year}
                  </button>
                ))}
